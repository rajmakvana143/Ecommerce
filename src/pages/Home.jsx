  ...
  return (
    <div className=' bg-slate-200 w-full min-h-screen'>
        ...
        {!input?<div className='flex flex-wrap justify-center items-center gap-5 w-[100%]'>
           ...
           return  <div key={index} className='w-[140px] h-[150px] bg-white flex flex-col items-start
        ...
        <div className='w-full flex flex-wrap gap-5 px-5 justify-center items-center pt-8 pb-8'>
            {cate.length>1? cate.map((item,index)=>(
              <Card key={index}  name={item.food_name} image={item.food_image}
          ...
          <div className={`w-full md:w-[40vw] h-[100%] top-0 right-0 bg-white shadow-xl flex flex-col items-center fixed  
          p-6 transition-all duration-400 overflow-auto pl-2 ${showCart?"translate-x-0":"translate-x-full"} `}>
              ...
              <header className='w-[100%] flex justify-between items-center '>
                ...
                <RxCross2 className='w-[25px] h-[25px]  text-green-400 text-[18px] 
              ...
              flex flex-col gap-2 p-8'>
                  ...
                  <div className='w-full flex justify-between items-center'>
                    ...
                    <span className='text-green-400 font-semibold text-lg'>Rs{items.length > 0 ?deliveryFee : 0}/-</span>
                  </div>
                ...
                <div className='w-full flex justify-between items-center p-9'>
                 ...
                 <span className='text-green-400 font-semibold text-2xl'>Rs {items.length > 0? total : 0}/-</span>
                </div>   

              <button className='w-[80%] p-3 rounded-lg bg-green-500 text-white 
              hover:bg-green-400 transition-all' onClick={()=>{toast.success("Order Placed..")}}>Place Order</button>    
        </>: 
